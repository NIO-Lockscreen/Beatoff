...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const merged: GlobalLeaderboard = {
      purist:   [...existing.purist],
      prestige: [...existing.prestige],
      rich:     [...existing.rich],
      mommy:    [...existing.mommy],
    };
...
<p class="warn" style="margin-top:30px;">⚠️ You can now delete <code>/api/migrate.ts</code> from GitHub — it's no longer needed.</p>
</body></html>`;
